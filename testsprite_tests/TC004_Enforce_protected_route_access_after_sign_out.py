...
async def run_test():
    ...
    try:
        ...
        # -> Enter credentials into the login form and submit (fill email, fill password, click 'Sign In').
        ...
        # -> Click the Sign In button to submit the login form and wait for the app to redirect to the authenticated area (dashboard/profile). If login succeeds, continue to open profile; if not, report and stop.
        frame = context.pages[-1]
        # Click element
