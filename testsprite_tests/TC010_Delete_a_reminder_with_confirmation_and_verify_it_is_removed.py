...
async def run_test():
    ...
    try:
        ...
        # -> Click the Sign In button to submit credentials and wait for the app to redirect to the dashboard or show the reminders page.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        assert not await frame.locator("xpath=//*[contains(., 'Test Medicine')]").nth(0).is_visible(), "The deleted reminder should no longer be visible in the reminders list after confirming deletion."
