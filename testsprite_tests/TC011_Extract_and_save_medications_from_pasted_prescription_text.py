...
async def run_test():
    ...
    try:
        ...
        # -> Submit the login form by clicking the visible Sign In button.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Paracetamol 500mg 1 tablet twice daily for 5 days')]").nth(0).is_visible(), "The medications list should show Paracetamol 500mg 1 tablet twice daily for 5 days after the prescription is extracted and saved."
