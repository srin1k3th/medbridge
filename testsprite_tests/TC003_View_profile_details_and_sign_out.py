...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with example@gmail.com and the password with password123, then submit the form.
        ...
        # -> Click the visible Sign In button to (re-)submit the login and wait for the app to navigate to the user's dashboard/profile.
        frame = context.pages[-1]
        # Click element
