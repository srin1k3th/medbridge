...
async def run_test():
    ...
    try:
        ...
        # -> Click the Sign In button to submit the login and wait for the app to redirect to the reminders/dashboard.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Aspirin 100mg')]").nth(0).is_visible(), "The reminders list should show the newly added medicine reminder Aspirin 100mg after adding it."
